...
scaler = load(open(r'C:\Users\Jyothi\Desktop\Projects\us_housing\Scalar.pkl',"rb"))
Random_model=load(open(r'C:\Users\Jyothi\Desktop\Projects\us_housing\Random_forest_model.pkl','rb'))
